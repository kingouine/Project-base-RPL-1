            ...
            <div class="row mb-2">
                ...
                <div class="col-8">
                    ...
                    <select name="status" class="form-control @error('status') is-invalid
                        ...
                        <option value="3" {{ $tugas->status== '3' ? 'selected' : '' }}>Proses Validasi</option>
                ...
                <div class="col-8">
                    ...
                    <textarea name="timbal_balik" rows="4"
                        class="form-control">{{ old('timbal_balik', $tugas->timbal_balik) }}</textarea>
                </div>
